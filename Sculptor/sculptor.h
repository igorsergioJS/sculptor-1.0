...
public:
  ...
  */
   ...
   * @param x0 x0 armazena a coordenada inicial da caixa no eixo x;
   * @param x1 x1 armazena a coordenada final da caixa no eixo x;
   * @param y0 y0 armazena a coordenada inicial da caixa no eixo y;
   * @param y1 y1 armazena a coordenada final da caixa no eixo y;
   * @param z0 z0 armazena a coordenada inicial da caixa no eixo z;
   * @param z1 z1 armazena a coordenada final da caixa no eixo z;
   */
